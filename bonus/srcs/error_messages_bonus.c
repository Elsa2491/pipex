...
/*   Updated: 2024/03/14 19:07:30 by eltouma          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_missing_param(void)
{
	...
	ft_printf(2, " You must enter less than 1024 parameters. See the example below:\n");
	ft_printf(2, "\033[%dm\e[1m%s\e\033[0m", 32, ARROW);
	ft_printf(2, " \033[%dm./pipex\033[0m infile cmd1 cmd2 cmd3 ... outfile\n", 33);
	ft_print_footer();
}
